const mainDiv = document.getElementById('movie-library')
const movie=[
    
        {
          ...
          "Poster": "https://m.media-amazon.com/images/M/MV5BM2YwYTkwNjItNGQzNy00MWE1LWE1M2ItOTMzOGI1OWQyYjA0XkEyXkFqcGdeQXVyMTUzMTg2ODkz._V1_FMjpg_UX1000_.jpg",
          "Ratings": [
            {
        ...
        },
        {
          ...
          "Director": "One · Yusuke Murata · Shueisha.",
          ...
          "Poster": "https://dwgkfo5b3odmw.cloudfront.net/manga/thumbs/thumb-91392-OnePunchMan_GN23_C1_Web-3-4BcVGZwYSJISVJsALoBDOw.jpg",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "6.4/10"
        ...
        },
        {
          ...
          "Poster": "https://pbs.twimg.com/media/FpKGaWaaQAQpn_M.jpg",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "8.2/10"
        ...
        },
        {
          ...
          "Poster": "https://m.media-amazon.com/images/M/MV5BZDZiZTZhMzgtYTY0ZC00OGUyLWE2NzgtMmM4MjA1YjUxN2YyXkEyXkFqcGdeQXVyMTA3MDk2NDg2._V1_.jpg",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "7.8/10"
        ...
        },
        {
          ...
          "Poster": "https://www.denofgeek.com/wp-content/uploads/2020/11/EiqW9MsWoAIhUpZ.jpeg?resize=724,1024",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "8.1/10"
        ...
        },
        {
          ...
          "Poster": "https://images.cdn2.buscalibre.com/fit-in/360x360/3e/b6/3eb6d75aaa7ef23f59fe4b0d4ec6e093.jpg",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "7.3/10"
        ...
        },
        {
          ...
          "Poster": "https://hips.hearstapps.com/hmg-prod/images/my-hero-academia-season-7-release-date-6576f8550e363.jpeg",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "8.1/10"
        ...
        },
        {
          ...
          "Poster": "https://m.media-amazon.com/images/M/MV5BY2I2MzI1ODYtMWRlOS00MzdhLWEyOWEtYWJhNmFiZTIxMGJhXkEyXkFqcGdeQXVyMTExNDQ2MTI@._V1_.jpg",
          "Ratings": [
            {
              "Source": "Internet Movie Database",
              "Value": "7.3/10"
...
movie.forEach(function(movie){
    ...
    const movieDiv = document.createElement('div')//div created
    const img = document.createElement('img')//image taken from json
    img.src = movie.Poster//image name is poster
    const Title = document.createElement('h2')//h2 created
    Title.textContent = movie.Title// h2 named as title
    const Year = document.createElement('h4')//h4 created
    Year.textContent = movie.Year//h4 created as year
    const Director = document.createElement('h4')//h4 created 
    Director.textContent = movie.Director//h4 name as director
    movieDiv.appendChild(img)//image append to the div
    movieDiv.appendChild(Title)//title append to the div
    movieDiv.appendChild(Year)//year append to the div
    movieDiv.appendChild(Director)//director append to the div
    movieDiv.classList.add('movie')//create a class for divs
    mainDiv.appendChild(movieDiv)//main div appends the moviediv'
...
function change()
{
  ...
  document.body.style.background = colorList[place];
  place++;
